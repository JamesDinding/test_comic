...
import { useContext, useEffect, useRef, MutableRef, useState, StateUpdater } from "preact/hooks";
import { h, createContext, FunctionComponent } from "preact";

// 建立上下文
const ObserverContext = createContext<ObserverContextType>(null!);

export const ObserverProvider: FunctionComponent<ObserverProviderProps> = ({ rootElement, children }) => {
